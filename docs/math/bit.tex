...
\begin{tabular}{crc}
\hline
操作& 集合表示& 位运算语句\\交集& a \cap b& a & b\\并集& a \cup b& a | b\\补集& \bar{a}& ~a\\差集& a \setminus b& ~a\\对称差& a\triangle b& a ^ b\\\hline
\end{tabular}
...
位运算技巧：\href{https://graphics.stanford.edu/~seander/bithacks.html}{}
